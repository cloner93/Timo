...
public class TabFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v=inflater.inflate(R.layout.tab_fragment2, container, false);

        ImageView emptyimg = (ImageView)v.findViewById(R.id.imageView5);
        int vid=values.plan_day_id;
        int vtab=values.tab_number;
        int vday=values.plan_day_num;

        ListView ag=(ListView) v.findViewById(R.id.listView3);
        ...
        z = k.getAll12(vid, 2);
        q = k.getAll13(vid, 2);
        Log.e("----->>" + String.valueOf(vid), "tab2 id");
        Log.e("----->>" + String.valueOf(vtab), "tab2 tab num");
    ...
    public void onResume() {
        ...
        ImageView emptyimg = (ImageView)getActivity().findViewById(R.id.imageView5);
        int vid=values.plan_day_id;
        int vtab=values.tab_number;
        int vday=values.plan_day_num;

        ListView ag=(ListView) getActivity().findViewById(R.id.listView3);
