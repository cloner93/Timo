...
public class TabFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v=inflater.inflate(R.layout.tab_fragment1, container, false);


        ImageView emptyimg = (ImageView)v.findViewById(R.id.imageView4);
        int vid=values.plan_day_id;
        int vtab=values.tab_number;
        int vday=values.plan_day_num;

        ListView ag=(ListView) v.findViewById(R.id.listView2);
            ...
            z = k.getAll12(vid, 1);
            q = k.getAll13(vid, 1);
            Log.e("----->>" + String.valueOf(vid), "tab1 id");
            Log.e("----->>" + String.valueOf(vtab), "tab1 tab num");
    ...
    public void onResume() {
        ...
        ImageView emptyimg = (ImageView)getActivity().findViewById(R.id.imageView4);
        int vid=values.plan_day_id;
        int vtab=values.tab_number;
        int vday=values.plan_day_num;

        ListView ag=(ListView) getActivity().findViewById(R.id.listView2);
