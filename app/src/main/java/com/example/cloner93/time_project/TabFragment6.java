...
public class TabFragment6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView emptyimg = (ImageView)v.findViewById(R.id.imageView9);
        int vid=values.plan_day_id;
        int vtab=values.tab_number;
        int vday=values.plan_day_num;

        ListView ag=(ListView) v.findViewById(R.id.listView7);
        ...
        z = k.getAll12(vid, 6);
        q = k.getAll13(vid, 6);
        Log.e("----->>" + String.valueOf(vid), "tab6 id");
        Log.e("----->>" + String.valueOf(vtab), "tab6 tab num");
    ...
    public void onResume() {
        ...
        ImageView emptyimg = (ImageView)getActivity().findViewById(R.id.imageView9);
        int vid=values.plan_day_id;
        int vtab=values.tab_number;
        int vday=values.plan_day_num;

        ListView ag=(ListView) getActivity().findViewById(R.id.listView7);
