...
public class TabFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v=inflater.inflate(R.layout.tab_fragment3, container, false);

        ImageView emptyimg = (ImageView)v.findViewById(R.id.imageView6);
        ...
        z = k.getAll12(vid, 3);
        q = k.getAll13(vid, 3);
        Log.e("----->>" + String.valueOf(vid), "tab3 id");
        Log.e("----->>" + String.valueOf(vtab), "tab3 tab num");
    ...
    public void onResume() {
        ...
        ImageView emptyimg = (ImageView)getActivity().findViewById(R.id.imageView6);
        int vid=values.plan_day_id;
        int vtab=values.tab_number;
        int vday=values.plan_day_num;

        ListView ag=(ListView) getActivity().findViewById(R.id.listView4);
